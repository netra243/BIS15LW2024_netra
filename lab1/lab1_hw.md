...
ANS: R is a programming language which is used for graphs and statistics whereas RStudio is an interface that provides a script to make it easier to write codes. GitHub is an online platfrom which programmers use for uploading, editing, and storing their codes which can be public or private. 
